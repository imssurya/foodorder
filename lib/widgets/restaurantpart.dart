...
import 'package:foodorder/widgets/smallbutton.dart';
import 'package:transparent_image/transparent_image.dart';

class RestaurantPart extends StatelessWidget {
  final RestaurantModel restaurant;

  const RestaurantPart({Key key, this.restaurant}) : super(key: key);
  @override
